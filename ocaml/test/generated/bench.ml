...
module Struct = struct
  ...
  let set_foo__2 b i (id_, count_, prefix_, length_) =
    Rt.Builder.Unsafe.set_scalar TULong b (i + 0) id_;
    Rt.Builder.Unsafe.set_scalar TShort b (i + 8) count_;
    Rt.Builder.Unsafe.set_scalar TByte b (i + 10) prefix_;
    Rt.Builder.Unsafe.set_padding b (i + 11) 1;
    Rt.Builder.Unsafe.set_scalar TUInt b (i + 12) length_;
    ()

  let set_bar__3 b i (parent_, time_, ratio_, size_) =
    set_foo__2 b (i + 0) parent_;
    Rt.Builder.Unsafe.set_scalar TInt b (i + 16) time_;
    Rt.Builder.Unsafe.set_scalar TFloat b (i + 20) ratio_;
    Rt.Builder.Unsafe.set_scalar TUShort b (i + 24) size_;
    Rt.Builder.Unsafe.set_padding b (i + 26) 6;
    ()
end
